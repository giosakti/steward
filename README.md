...
are available through an authenticated HTTP API and CLI. The API also records
Decision Kernel evaluations of configuration proposals. Agent execution and
...
- [Decision evaluation](docs/decisions.md)
